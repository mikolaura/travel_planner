...
def get_weather(location: str, date_start: str, date_end: str) -> list:
    ...
    r = requests.get(
        f"https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/{location}/{date_start}/{date_end}?unitGroup=metric&key=AMY4SZWQ4BPPTGAZYHZKNZALU&contentType=json"
    )
    # print(r.json())
